...
hist(height, main = "Histogram of students",prob=TRUE, xlab = "Heights (cm)")
...
```{r}
### Write your code here
pnorm(188, mean=188, sd=6.53, lower.tail = FALSE)
...
```{r}
### Write your code here
pnorm(211, mean=188, sd=6.53, lower.tail = FALSE)
...
pnorm(180,mean = 188, sd=6.53) - pnorm(170 ,mean = 188, sd=6.53)
